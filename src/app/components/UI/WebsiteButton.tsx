...
function WebdevelopmentPlanModal({ onClose }: { onClose: () => void }) {
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[12px] text-[#5a8078] leading-[1.55]">
                           Build a high-performing, user-friendly website designed to engage visitors and drive business growth.
                        </p>
                    </div>
                    {/* close */}
                    <button
...
export default function WebdevelopmentPlanButton() {
    ...
    return (
        <>
            ...
            <button
                ...
                className="group inline-flex items-center gap-1 rounded-full border-[1.5px] border-[#3cba99] bg-transparent px-3 md:px-3 py-4 text-sm font-medium text-[#0a5c45] transition-all duration-200 hover:bg-[var(--primary-green)] hover:text-white hover:-translate-y-px active:scale-[0.97] sm:px-5 sm:py-3 sm:text-md cursor-pointer"
            >
                Get Website Plan
                <svg
            ...
            {mounted && open && <WebdevelopmentPlanModal onClose={closeModal} />}
        </>
    );
}