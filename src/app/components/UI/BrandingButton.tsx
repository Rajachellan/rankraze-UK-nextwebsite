...
function BrandPlanModal({ onClose }: { onClose: () => void }) {
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[12px] text-[#5a8078] leading-[1.55]">
                           Develop a consistent and impactful brand that drives engagement, builds trust, and fuels business growth.
                        </p>
                    </div>
                    {/* close */}
                    <button
...
export default function BrandPlanButton() {
    ...
    return (
        <>
            ...
            {mounted && open && <BrandPlanModal onClose={closeModal} />}
        </>
    );
}