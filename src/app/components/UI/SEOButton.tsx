...
function SEOPlanModal({ onClose }: { onClose: () => void }) {
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[12px] text-[#5a8078] leading-[1.55]">
                         Improve your website’s visibility and rankings with a data-driven SEO strategy designed to drive organic traffic and long-term growth.
                        </p>
                    </div>
                    {/* close */}
                    <button
...
export default function SEOPlanButton() {
    ...
    return (
        <>
            ...
            {mounted && open && <SEOPlanModal onClose={closeModal} />}
        </>
    );
}