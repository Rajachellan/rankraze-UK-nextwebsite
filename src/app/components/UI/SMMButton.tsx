...
function SMMPlanModal({ onClose }: { onClose: () => void }) {
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <h2 className="font-['Sora',sans-serif] text-[17px] font-bold text-[#0a2218] leading-[1.25] tracking-[-0.02em] mb-0.5">
                            Get Your Social Plans
                        </h2>
                        <p className="text-[12px] text-[#5a8078] leading-[1.55]">
                         Grow your brand presence and engage your audience with strategic social media campaigns that drive awareness and generate leads.
                        </p>
                    </div>
                    {/* close */}
                    <button
...
export default function SMMPlanButton() {
    ...
    return (
        <>
            ...
            {mounted && open && <SMMPlanModal onClose={closeModal} />}
        </>
    );
}